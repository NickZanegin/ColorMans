...
public class CameraShake : MonoBehaviour
{
    ...
    public void DoShake()
    {
        ...
        var speed = 0.055f;
        var shake1 = new Vector3(4, 24.4f, -29.5f);
        var shake2 = new Vector3(2, 24.4f, -30.5f);
        var shake3 = new Vector3(4, 24.4f, -30.23f);
        var shake4 = new Vector3(2, 24.4f, -29.5f);
        var shake5 = new Vector3(4, 24.4f, -30.23f);
